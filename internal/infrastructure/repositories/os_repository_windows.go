...
func (it *DefaultOSRepository) Download(url, tempFilePath string) error {
...
func (it *DefaultOSRepository) GetTempDir() string {
	return "/tmp"
}

func (it *DefaultOSRepository) GetInstallationPath() string {
	return "/usr/local/bin"
}

func (it *DefaultOSRepository) extract(tempFilePath, destPath string) error {
...
func (it *DefaultOSRepository) move(tempFilePath, destPath string) error {
...
func (it *DefaultOSRepository) remove(tempFilePath string) error {
...
func (it *DefaultOSRepository) makeExecutable(filePath string) error {
