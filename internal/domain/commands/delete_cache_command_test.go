...
func TestNewDeleteCacheCommand_ShouldCreateInstance_WhenCalled(t *testing.T) {
...
func TestDeleteCacheCommand_ShouldDeleteTargetDirectories_WhenExecuteCalledWithValidPaths(t *testing.T) {
...
func TestDeleteCacheCommand_ShouldCompleteWithoutError_WhenEmptyListProvided(t *testing.T) {
...
func TestDeleteCacheCommand_ShouldCompleteWithoutError_WhenNonExistentDirectoriesProvided(t *testing.T) {
...
func TestDeleteCacheCommand_ShouldDeleteOnlySpecifiedDirectories_WhenSelectiveExecutionRequested(t *testing.T) {
