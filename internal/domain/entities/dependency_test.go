...
func TestDependency_GetBinaryURL(t *testing.T) {
	...
	t.Run(
		"should generate platform specific URL when platform variations used",
		func(t *testing.T) {
			t.Parallel()
			// GIVEN: A dependency with platform placeholders
			dependency := entitybuilders.NewDependencyBuilder().
				WithBinaryURL("https://example.com/%[1]s/%[2]s_%[3]s").
				BuildDependency()
			version := "1.0.0"
	...
	t.Run(
		"should use simple version format when backward compatibility required",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"should include OS information when platform format with OS placeholder used",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"should include arch information when platform format with arch placeholder used",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"should generate linux arm64 URL when terraform with android arm64 used",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"should generate linux arm64 URL when terragrunt with android arm64 used",
		func(t *testing.T) {
			t.Parallel()
